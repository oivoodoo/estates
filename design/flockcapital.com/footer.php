	        ...
	        <footer id="footer">
	        	...
	        	<div class="quicknav">
		        	...
		        	<div>
			        	<h6>Site Links</h6>
			        	<ul>
				        	<li><a href="javascript:void(0)">I've never</a></li>
				        	<li><a href="javascript:void(0)">found these</a></li>
				        	<li><a href="javascript:void(0)">columns</a></li>
				        	<li><a href="javascript:void(0)">of links</a></li>
				        	<li><a href="javascript:void(0)">useful.</a></li>
				        	<li><a href="javascript:void(0)">They were</a></li>
				        	<li><a href="javascript:void(0)">invented</a></li>
			        	</ul>
		        	</div>
		        	<div>
			        	<h6>Support & Legal</h6>
			        	<ul>
				        	<li><a href="javascript:void(0)">back in the days</a></li>
				        	<li><a href="javascript:void(0)">to simulate</a></li>
				        	<li><a href="javascript:void(0)">better indexing</a></li>
				        	<li><a href="javascript:void(0)">when</a></li>
				        	<li><a href="javascript:void(0)">searchbots</a></li>
				        	<li><a href="javascript:void(0)">crawl</a></li>
				        	<li><a href="javascript:void(0)">your</a></li>
			        	</ul>
		        	</div>
		        	<div>
			        	<h6>Community</h6>
			        	<ul>
				        	...
				        	<li><a href="javascript:void(0)">For humans</a></li>
				        	<li><a href="javascript:void(0)">it would</a></li>
				        	<li><a href="javascript:void(0)">be much</a></li>
				        	<li><a href="javascript:void(0)">clearer</a></li>
				        	<li><a href="javascript:void(0)">to use a</a></li>
				        	<li><a href="javascript:void(0)">sitemap.</a></li>
			        	</ul>
		        	</div>*/ ?>
		        	<div>
		        		<?php /*<h5>Quick Links</h5>*/ ?>
			        	<ul>
				        	<li><a href="javascript:void(0)">Sitemap</a></li>
		        	...
		        	<div>
			        	<form id="newsletter-subscription-form">
			        		<?php /*<h4>Not ready to invest yet?</h4>*/ ?>
			        		<input type="email" placeholder="you@somewhere.com"><button></button>
			        		<p>Subscribe to our monthly newsletter and stay up to date with what's cookin'</p>
			        	</form>
		        	</div>
	        	</div>
