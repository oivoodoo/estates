        		...
        		<div>
	        		<div id="logo">
	        			<div>
							<h1 itemprop="logo">
								<a href="?">
									<?php /*<svg version="1.1" id="logo-symbol" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 661.46 362.739" xml:space="preserve">
										<path d="M413.46,179.479c-0.86,0.53-1.729,1.062-2.602,1.58c-0.17,0.101-0.33,0.21-0.5,0.311h-0.01
